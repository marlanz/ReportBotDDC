...
def main():
    with sync_playwright() as p:
        ...
        # Check default value
        input_el = page.locator("input.input-maKH").first
        ...
        # Open client modal by clicking the input with class .openChonMaKH
        print("\nOpening client modal by clicking input.openChonMaKH...")
        input_el.click()
        ...
        # Check displayed client name
        client_name = page.locator(".thongTin_maKH_dangchon .ten").first.inner_text().strip()
        print(f"  Displayed client name: {client_name}")
