...
def main():
    with sync_playwright() as p:
        ...
        # Print all btn-tracuu visibilities
        ...
        # Now click the visible lookup button
        visible_button = page.locator("button.btn-tracuu:visible").first
        if visible_button.count() > 0:
            print("\nClicking visible lookup button...")
            visible_button.click()
        else:
            print("\n[ERROR] No visible lookup button found!")
